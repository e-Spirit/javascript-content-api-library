...
export class FSXARemoteApi implements FSXAApi {
  ...
  async fetchByFilter(
    ...
    const contentType = caasApiResponse.headers.get('content-type')

    console.log('contentType remote api', contentType)
    ...
    return { page: 1, pagesize: 1, totalPages: 1, size: 1, items: [] } as FetchResponse
  }
